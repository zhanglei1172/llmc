...
PYTHONPATH='.' llmc=./llmc ${python_path} -m torch.distributed.run --nnode 1 --nproc_per_node 1 --rdzv_id 1175 --rdzv_backend c10d --rdzv_endpoint localhost:12358 ./llmc/__main__.py --config configs/quantization/combination/quarot_comb_gptq/w8a8/v4_test_step_1.5_smoothquantcustom.yml --task_id 1175  > log_smoothquant.log 2>&1